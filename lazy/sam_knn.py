...
# from core import BaseSKMObject, ClassifierMixin
# from lazy.src import libNearestNeighbors
...
print(evaluate.progressive_val_score(dataset, model, metric))  # doctest: +SKIP
# Accuracy: 56.70%

A = np.random.random([3,4,5])
print(A)
print(dict(np.ndenumerate(A)))
print(dict(enumerate(A.flatten(), 1)))
...
#     Examples
#     --------
#     >>> from lazy import SAMKNNClassifier
...
#         self.window = InstanceWindow(self, max_size=max_window_size, dtype=float)
